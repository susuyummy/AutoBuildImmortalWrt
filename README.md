...
> 2、支持预安装docker（可选）<br>
> 3、目前支持 x86-64、rockchip、armsr-armv8、glinet、mediatek-filogic、sunxi-cortexa53 和 raspberrypi 等多个平台<br>
...
## 开发
本仓库在 GitHub Actions 中增加了 ShellCheck 步骤，用于对所有 `*.sh` 脚本进行静态检查，若发现问题则工作流会失败。
